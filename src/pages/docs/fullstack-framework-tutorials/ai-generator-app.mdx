...
The basic starter version of this template is [on GitHub](https://github.com/tierrun/tier-vercel-openai) and it uses Tier, OpenAI, NextJs (fullstack JS), Vercel (hosting and DB) and Stripe. 
